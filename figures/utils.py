...
def label_axes(axes: list[Axes], labels: list[str] | None = None, fontsize: int = 12) -> None:
...
def annotate_pearson_r(ax: Axes, r: float, xy: tuple[float, float] = (0.05, 0.92)) -> None:
